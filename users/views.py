...
def userAccount(request):
    profile = request.user.profile #get logged in user
...
def editAccount(request):
    ...
    form = ProfileForm(instance=profile) #prefill the info in form
...
def deleteSkill(request, pk):
    ...
    context = {'object': skill} #the key should be object because it is passed as object 
